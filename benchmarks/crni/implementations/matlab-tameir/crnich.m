...
%-----------------------------------------------------------------------
  ...
  [h] = mrdivide(mc_t130, mc_t131);
  mc_t132 = b;
  mc_t171 = 1;
  [mc_t133] = minus(m, mc_t171);
  [k] = mrdivide(mc_t132, mc_t133);
  mc_t172 = 2;
  [mc_t136] = mpower(c, mc_t172);
  mc_t137 = k;
  [mc_t134] = mtimes(mc_t136, mc_t137);
  mc_t173 = 2;
  [mc_t135] = mpower(h, mc_t173);
  [r] = mrdivide(mc_t134, mc_t135);
  mc_t174 = 2;
  [mc_t138] = mrdivide(mc_t174, r);
  mc_t175 = 2;
  [s1] = plus(mc_t175, mc_t138);
  mc_t176 = 2;
  [mc_t139] = mrdivide(mc_t176, r);
  mc_t177 = 2;
  ...
  mc_t183 = 2;
  for i1 = (mc_t183 : mc_t150);
% u(x, 0)=sin(C_PI*x)+sin(3*C_PI*x).
    [mc_t148] = mtimes(C_PI, h);
    mc_t179 = 1;
    [mc_t149] = minus(i1, mc_t179);
    [mc_t147] = mtimes(mc_t148, mc_t149);
    [mc_t140] = sin(mc_t147);
    mc_t180 = 3;
    [mc_t145] = mtimes(mc_t180, C_PI);
    mc_t146 = h;
    [mc_t143] = mtimes(mc_t145, mc_t146);
    mc_t181 = 1;
    [mc_t144] = minus(i1, mc_t181);
    [mc_t142] = mtimes(mc_t143, mc_t144);
    [mc_t141] = sin(mc_t142);
  ...
  for j1 = (mc_t208 : m);
    ...
    for i1 = (mc_t206 : mc_t169);
      ...
      [mc_t158] = mtimes(mc_t159, mc_t160);
...
% n=size(B, 2);
  ...
  for k = (mc_t242 : n);
    ...
    [mc_t220] = C(mc_t221);
    [mc_t218] = mtimes(mc_t219, mc_t220);
    ...
    [mc_t225] = B(mc_t226);
    [mc_t223] = mtimes(mc_t224, mc_t225);
  ...
  mc_t247 = 1;
  for k = (mc_t236 : mc_t237 : mc_t247);
    [mc_t231] = B(k);
    [mc_t233] = C(k);
    mc_t246 = 1;
    [mc_t235] = plus(k, mc_t246);
    [mc_t234] = X(mc_t235);
    [mc_t232] = mtimes(mc_t233, mc_t234);
