...
%-----------------------------------------------------------------------
  mc_t172 = 0.5;
  [mc_t150] = mtimes(mc_t172, c);
  mc_t151 = n;
  [h] = mrdivide(mc_t150, mc_t151);
% Grid size.
  mc_t173 = 0.5;
  [mc_t153] = mtimes(mc_t173, a);
  mc_t154 = h;
  [mc_t152] = mrdivide(mc_t153, mc_t154);
  [na] = round(mc_t152);
%x=linspace(0, 0.5*c, n+1);
  mc_t174 = 0.5;
  [mc_t156] = mtimes(mc_t174, d);
  mc_t157 = h;
  [mc_t155] = mrdivide(mc_t156, mc_t157);
  [m] = round(mc_t155);
  mc_t175 = 0.5;
  [mc_t159] = mtimes(mc_t175, b);
  mc_t160 = h;
  [mc_t158] = mrdivide(mc_t159, mc_t160);
  [mb] = round(mc_t158);
...
%-----------------------------------------------------------------------
  ...
  for ii = (mc_t283 : n);
    ...
    for jj = (mc_t282 : m);
      ...
      mc_t281 = 0.25;
      [mc_t218] = mtimes(mc_t281, mc_t220);
      [mc_t219] = f(ii, jj);
      [mc_t217] = minus(mc_t218, mc_t219);
      [mc_t215] = mtimes(mc_t216, mc_t217);
...
% Symmetry on left boundary ii-1 -> ii+1.
  ...
  for jj = (mc_t289 : m);
    ...
    mc_t288 = 0.25;
    [mc_t239] = mtimes(mc_t288, mc_t241);
    [mc_t240] = f(ii, jj);
    [mc_t238] = minus(mc_t239, mc_t240);
    [mc_t236] = mtimes(mc_t237, mc_t238);
...
% Symmetry on lower boundary jj-1 -> jj+1.
  ...
  for ii = (mc_t295 : n);
    ...
    mc_t294 = 0.25;
    [mc_t260] = mtimes(mc_t294, mc_t262);
    [mc_t261] = f(ii, jj);
    [mc_t259] = minus(mc_t260, mc_t261);
    [mc_t257] = mtimes(mc_t258, mc_t259);
...
%-----------------------------------------------------------------------
  ...
  for ii = (mc_t205 : n);
    ...
    mc_t204 = 0.5;
    [mc_t190] = mtimes(mc_t191, mc_t204);
  ...
  for jj = (mc_t208 : m);
    ...
    mc_t207 = 0.5;
    [mc_t197] = mtimes(mc_t198, mc_t207);
    [q] = plus(mc_t196, mc_t197);
  end
  mc_t209 = 4;
  [cap] = mtimes(q, mc_t209);
% Four quadrants.
  mc_t210 = 8.854187;
  [cap] = mtimes(cap, mc_t210);
end
